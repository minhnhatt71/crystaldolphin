...
func NewTelegramChannel(cfg *channel.TelegramConfig, b *bus.InboundBus) *TelegramChannel {
	return &TelegramChannel{
		Base: NewBase(channelmodel.ChannelTelegram, b, cfg.AllowFrom),
		cfg:  cfg,
	}
}

func (t *TelegramChannel) Name() channelmodel.ChannelName { return channelmodel.ChannelTelegram }
...
func (t *TelegramChannel) Send(_ context.Context, msg channelmodel.Message) error {
	if t.bot == nil {
