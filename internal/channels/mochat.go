...
func (m *MochatChannel) Name() channelmodel.ChannelName { return channelmodel.ChannelMochat }
...
func (m *MochatChannel) Send(ctx context.Context, msg channelmodel.Message) error {
