...
func (w *WhatsAppChannel) Name() channelmodel.ChannelName { return channelmodel.ChannelWhatsApp }
...
func (w *WhatsAppChannel) Send(_ context.Context, msg channelmodel.Message) error {
