...
func (d *DiscordChannel) Name() channelmodel.ChannelName { return channelmodel.ChannelDiscord }
...
func (d *DiscordChannel) Send(ctx context.Context, msg channelmodel.Message) error {
