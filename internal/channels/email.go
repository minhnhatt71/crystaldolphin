...
func NewEmailChannel(cfg *channel.EmailConfig, b *bus.InboundBus) *EmailChannel {
	return &EmailChannel{
...
func (e *EmailChannel) Name() channelmodel.ChannelName { return channelmodel.ChannelEmail }
...
func (e *EmailChannel) Send(ctx context.Context, msg channelmodel.Message) error {
	to := msg.ChatId()
